    ...
    Plugin.prototype = {
        ...
        _loadAjaxFile: function (awidget, file, loader) {
            ...
            awidget.find('.widget-body').load(file, function (response, status, xhr) {
                 ...
                 **/
                if (status == "error") {
                    $this.html('<h4 class="alert alert-danger">' + self.o.labelError + '<b> ' + xhr.status +
                        " " + xhr.statusText + '</b></h4>');
                }
        ...
        _saveSettingsWidget: function () {
            ...
            if (storage && self.o.localStorage) {
                ...
                self.obj.find(self.o.widgets).each(function () {
                    ...
                    storeSettingsStr['collapsed'] = ($(this).hasClass('jarviswidget-collapsed') ? 1 :
                        0);
        ...
        init: function () {
                ...
                if (!thisHeader.parent().attr('role')) {
					...
					**/
                    ...
                    if (self.o.deleteButton === true && tWidget.data('widget-deletebutton') ===
                        undefined) {
                        var deleteBtn =
                            '<a href="javascript:void(0);" class="button-icon jarviswidget-delete-btn" rel="tooltip" title="删除" data-placement="bottom"><i class="' +
                    ...
                    if (self.o.fullscreenButton === true && tWidget.data('widget-fullscreenbutton') ===
                        undefined) {
                        var fullscreenBtn =
                            '<a href="javascript:void(0);" class="button-icon jarviswidget-fullscreen-btn" rel="tooltip" title="缩放" data-placement="bottom"><i class="' +
                    ...
                    if (self.o.toggleButton === true && tWidget.data('widget-togglebutton') ===
                        ...
                        var toggleBtn =
                            '<a href="#" class="button-icon jarviswidget-toggle-btn" rel="tooltip" title="折叠" data-placement="bottom"><i class="' +
                            toggleSettings + '"></i></a>';
                    } else {
                        toggleBtn = '';
                    }
                    ...
                    if (self.o.refreshButton === true && tWidget.data('widget-refreshbutton') !=
                        ...
                        var refreshBtn =
                            '<a href="#" class="button-icon jarviswidget-refresh-btn" data-loading-text="&nbsp;&nbsp;Loading...&nbsp;" rel="tooltip" title="刷新" data-placement="bottom"><i class="' +
            ...
            self.obj.find('[data-widget-load]').each(function () {
                ...
                if (!thisItem.find('.jarviswidget-ajax-placeholder').length) {
                     ...
                     **/
                    thisItem.children('widget-body').append(
                        '<div class="jarviswidget-ajax-placeholder">' + self.o.loadingLabel +
                        '</div>');
        ...
        _clickEvents: function () {
            ...
            self.widget.on(clickEvent, '[data-widget-setstyle]', function (e) {
                 ...
                 * Set the new style.
                 **/
                $(this).parents(self.o.widgets).attr('data-widget-attstyle', '' + val + '').removeClassPrefix(
                    'jarviswidget-color-').addClass(val);
