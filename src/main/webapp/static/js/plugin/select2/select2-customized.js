...
(function ($, undefined) {
    ...
    SingleSelect2 = clazz(AbstractSelect2, {
		...
		createContainer: function () {
            var container = $(document.createElement("div")).attr({
                ...
                "   </div>" ,
                "   <ul class='select2-results custom-scroll'>" ,
                "   </ul>" ,
                "</div>"].join(""));
            return container;
        },
		...
		showSearch: function(showSearchInput) {
			...
			if (!this.opts.showSearchInput) {
				this.dropdown.find(".select2-search").css("display", "none");
			} else {
				this.dropdown.find(".select2-search").css("display", "block");
			}
		},
        ...
        addSelectedChoice: function (data) {
            var enableChoice = !data.locked,
                enabledItem = $(
                    ...
                    "    <div></div>" +
                    "    <a href='javascript:void(0);' onclick='return false;' class='select2-search-choice-close' tabindex='-1'><i class='fa fa-times-circle txt-color-white'></i></a>" +
                    "</li>"),
                disabledItem = $(
    ...
    $.fn.select2.defaults = {
        ...
        formatNoMatches: function () { return "<i class='fa fa-warning txt-color-orange'></i> 没有匹配的结果"; },
