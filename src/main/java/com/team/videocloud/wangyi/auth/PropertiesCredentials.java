package com.team.videocloud.wangyi.auth;
...
public class PropertiesCredentials implements Credentials {
	...
	* @throws IOException
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.com.video.portal.wangyi.auth.Credentials#getAppKey()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.video.portal.wangyi.auth.Credentials#getAppSecret()
	 */
