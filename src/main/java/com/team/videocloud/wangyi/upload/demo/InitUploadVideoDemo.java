    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (initUploadVideoParam.getCode() == 200) {
                log.info("[InitUploadVideoDemo] init upload params successfully. " + initUploadVideoParam.getRet().toString());
            } else {
                log.info("[InitUploadVideoDemo] fail to init upload params. " + "return code " + initUploadVideoParam.getCode() + " return message " + initUploadVideoParam.getMsg());
            }
