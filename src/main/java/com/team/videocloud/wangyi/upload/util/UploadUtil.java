package com.team.videocloud.wangyi.upload.util;
...
import com.team.videocloud.wangyi.util.HttpClientBuilder;
import com.team.videocloud.wangyi.util.HttpGetBuilder;
import com.team.videocloud.wangyi.util.HttpPostBuilder;
...
//		logger.info("[UploadUtil] : json stringBody" + stringBody);
		...
		try {
			...
			log.error("[UploadUtil] json parse exception : "	+ e + ",msg : " + e.getMessage());
