...
public class ImageBase64Utils {	
	...
	public static String imageToBase64String(String imgFilePath) {		
		...
		try {
			...
			log.error("[CallbackImageBase64Utils] failed to change image to Base64String : " + e + ",msg : " + e.getMessage());
		}finally{
			if(null != in){
				try {
					in.close();
				} catch (IOException e) {
					log.error("[CallbackImageBase64Utils] failed to close InputStream : " + e + ",msg : " + e.getMessage());
				}
			}			
		}
